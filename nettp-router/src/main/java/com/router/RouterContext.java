...
import com.router.exception.DuplicateActionException;
import com.router.invocation.ActionInvocation;
...
public class RouterContext {
	...
	private String findNamespace(Class<?> actionClass, Method method, RouterConfig config){
		...
		if(nsAnnotation != null){
			...
			String retNs = null;
			for(com.router.config.Namespace ns : config.getNamespaces()){
